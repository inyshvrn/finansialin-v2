      ...
      <div className="grid grid-cols-12 gap-8">
        ...
        <div className="col-span-12 lg:col-span-8 space-y-8">
          <div className="bg-[#F6F5F1]/50 p-8 rounded-[40px] border border-[#E8E2D9] relative overflow-hidden h-[450px]">
             ...
             <div className="absolute inset-x-0 bottom-0 h-64 flex items-end">
                <svg viewBox="0 0 1000 200" className="w-full h-full">
                  <path 
                    d="M0,150 C150,50 350,180 500,100 C650,20 850,120 1000,50 L1000,200 L0,200 Z" 
                    fill="#FFD600" 
                    fillOpacity="0.1" 
                  />
                  <path 
                    d="M0,150 C150,50 350,180 500,100 C650,20 850,120 1000,50" 
                    stroke="#FFD600" 
                    strokeWidth="4" 
                    fill="none" 
                    strokeLinecap="round"
             ...
             <div className="absolute bottom-6 inset-x-12 flex justify-between">
                {['Jan', 'Feb', 'Mar', 'Apr', 'Mei', 'Jun'].map(m => (
                  <span key={m} className="text-[10px] font-black text-[#A3A3A3] uppercase">{m}</span>
                ))}
             </div>
          </div>
          ...
          <div className="space-y-4">
             <div className="flex justify-between items-center px-4">
                ...
                <button className="text-[10px] font-black text-[#7A746E] flex items-center gap-1">VIEW ALL <ChevronRight size={14}/></button>
             </div>
        ...
        <div className="col-span-12 lg:col-span-4 space-y-6">
          ...
          <div className="bg-[#1A1A1A] p-8 rounded-[40px] text-[#FFD600] relative overflow-hidden">
            ...
            <button className="w-full py-4 bg-[#FFD600] text-[#1A1A1A] rounded-2xl font-black text-[11px] uppercase tracking-widest hover:scale-[1.02] transition-transform">
              Learn More
            </button>
          </div>
          ...
          <div className="flex items-center justify-between p-6 bg-[#F6F5F1] rounded-[32px] border border-dashed border-[#A3A3A3]">
             <div className="flex items-center gap-3">
                <div className="p-2 bg-white rounded-xl shadow-sm"><Download size={18}/></div>
                <div>
