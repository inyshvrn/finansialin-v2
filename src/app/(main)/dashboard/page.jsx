...
const Header = ({ name }) => (
  <header className="flex justify-between items-center mb-10">
    <div>
      ...
      <p className="text-xl font-semibold -mt-1 text-[#1A1A1A]">Welcome back!</p>
    </div>
    <div className="flex items-center gap-6">
      ...
      <div className="flex items-center gap-4">
        <button className="relative p-2.5 bg-white rounded-full border border-[#E8E2D9] shadow-sm hover:bg-gray-50 transition-colors">
          <Bell size={22} />
          <div className="absolute top-2.5 right-2.5 w-2.5 h-2.5 bg-red-500 rounded-full border-2 border-white"></div>
        </button>
        <div className="w-12 h-12 rounded-full border-4 border-white shadow-lg bg-[#E8E2D9] flex items-center justify-center font-bold text-[#7A746E]">
          A
        </div>
      </div>
    </div>
